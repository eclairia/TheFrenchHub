<?php
	...
	function update_article($article, $url)
	{
		...
		try
		{
			$req = "UPDATE tfh_articles SET article_title = :article_title, article_content = :article_content, article_link = :article_link, article_picture_url = :article_picture_url WHERE article_id = :article_id";
