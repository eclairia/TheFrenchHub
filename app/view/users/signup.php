...
<div id="contentinscription">
    <div id="forminscription">
        ...
        <form id="formsignup" method="post" action="?module=users&action=signup">
            ...
            <div>
                <input class="formwidth borderform" name="user_last_name" type="text" placeholder="Nom" required>
            </div>

            <div>
                <input class="formwidth borderform" name="user_first_name" type="text" placeholder="Prénom" required>
            </div>

            <div>
                <input class="formwidth borderform" name="user_birth" type="date" min="1940/01/01" placeholder="Date de naissance" required>
            </div>

            <div>
                <input class="formwidth borderform" name="user_mail" type="email" placeholder="Adresse mail" required>
            </div>

            <div>
                <input class="formwidth borderform" name="user_login" type="text" placeholder="Identifiant" required>
            </div>

            <div>
                <input class="formwidth borderform" name="user_password" type="password" placeholder="Mot de passe" required>
            </div>

            <div>
                <input class="formwidth borderform" name="user_password2" type="password" placeholder="Confirmation mot de passe" required>
            </div>
